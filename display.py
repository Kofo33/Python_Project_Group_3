...
def display_combat(player):
    ...
    while running:
        ...
        enemy_health_bar = HealthBar(550, 50, current_enemy.name, current_enemy.health, current_enemy.max_health)
                        ...
                        if end_state == "victory":
                            ...
                            if event.key in [pygame.K_UP, pygame.K_DOWN]:
                                ...
                                if selected_button == 0:  # Restart
                                    ...
                                    current_enemy.restart(current_enemy.max_health)
                            ...
                            if end_state == "victory":
                                if selected_button == 0:  # Next level
                                    ...
                                    if current_enemy.name == "Bandit":
                                        current_enemy = bandit2
                                    elif current_enemy.name == "Bandit2":
                                        current_enemy = huntress
                                    elif current_enemy.name == "Huntress":
                                        current_enemy = bringer
                                    elif current_enemy.name == "Bringer":
                                        current_enemy = wizard
